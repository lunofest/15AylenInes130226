...
function updateTimer() {
  const targetDate = new Date("february 13, 2026 19:20:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543874682666'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543874682666'; // Número para el primer botón
